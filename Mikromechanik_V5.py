...
import platform
import pickle
#run=execfile('C:/Users/g.siroky/Documents/PhD/02 Modeling/01 Abaqus/02 Material Model/Mikromechanik_V5.py', __main__.__dict__)
...
startTime=time.time()
if System == 'Linux':
	os.chdir(r"/home/g.siroky/Modeling/abaqus/cyclicShear/wd")
elif System == 'Windows':
	os.chdir(r"C:\Users\g.siroky\Documents\PhD\02 Modeling\01 Abaqus\02 Material Model\wd")
...
for iParameters in Parameters:
	...
	#Steps
	#Step Apply Tension
	#mdb.models['one'].StaticStep(initialInc=0.5, maxInc=1.0, maxNumInc=1000, name='ApplyDisp', previous='Initial')
	...
	if Postprocessing == True:
		...
		if System == 'Linux':
			MicroODB=session.openOdb(name='/home/g.siroky/Modeling/abaqus/Anand/wd/' +  jobName + '.odb')
		elif System == 'Windows':
